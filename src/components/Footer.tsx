        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a 
                  key={index}
                  href={social.href}
                  className="w-9 h-9 rounded-full flex items-center justify-center text-muted-foreground hover:bg-secondary hover:text-primary transition-colors duration-200 border border-border"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Custom Software', 'Web Applications', 'UX/UI Design', 'Cybersecurity', 'System Architecture'].map((item, index) => (
                <li key={index}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'Compliance'].map((item, index) => (
                <li key={index}>
